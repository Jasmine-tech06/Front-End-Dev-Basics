...
import { FaCog, FaPalette, FaBell, FaShieldAlt, FaInfoCircle, FaSave } from "react-icons/fa";
...
function SettingsPage() {
  ...
  const handleToggle = (key) => {
    ...
    // Quick Theme apply mockup
    if (key === "theme") {
      const themeVal = updated.theme ? "dark" : "light";
      toast.success(`Theme switched to ${themeVal}!`);
    }
  };
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <div className="settings-option-row">
              <div className="settings-option-info">
                ...
                <p>Use a professional dark SaaS layout glow theme.</p>
              </div>
